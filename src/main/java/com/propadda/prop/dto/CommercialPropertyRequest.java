...
public class CommercialPropertyRequest {
    ...
    private Integer commercialOwnerId;
    private Boolean vip;
    ...
    public Integer getCommercialOwnerId() {
        return commercialOwnerId;
    }

    public void setCommercialOwnerId(Integer commercialOwnerId) {
        this.commercialOwnerId = commercialOwnerId;
    }
