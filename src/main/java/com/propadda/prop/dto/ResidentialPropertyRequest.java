...
public class ResidentialPropertyRequest {
    ...
    private Integer residentialOwnerId;
    private Boolean vip;
    ...
    public Integer getResidentialOwnerId() {
        return residentialOwnerId;
    }

    public void setResidentialOwnerId(Integer residentialOwnerId) {
        this.residentialOwnerId = residentialOwnerId;
    }
