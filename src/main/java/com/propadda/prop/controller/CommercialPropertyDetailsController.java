...
public class CommercialPropertyDetailsController {
    ...
    public ResponseEntity<CommercialPropertyDetails> createPropertyWithUploadedMedia(
            @RequestBody PropertyWithUploadedMediaRequest<CommercialPropertyRequest> req)
